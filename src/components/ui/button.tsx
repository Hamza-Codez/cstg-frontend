...
const VARIANTS: Record<ButtonVariant, string> = {
  ...
  secondary: "bg-surface text-structure border border-structure hover:bg-canvas",
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "inline-flex cursor-pointer items-center justify-center gap-2 rounded-sm px-3.5 py-1.5",
